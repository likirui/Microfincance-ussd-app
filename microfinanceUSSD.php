			...
			switch ($userResponse) {
			    ...
			    case "4":
			    	if($level==1){
						...
						$response = "CON You can only send 200 shillings.\n";
						$response .= " Enter a valid phonenumber (like 0773172123)\n";					
			  			// Print the response onto the page so that our gateway can read it
			  			header('Content-type: text/plain');
 			  			echo $response;	
						...
						$newBal -= 200;				
						    ...
						    if($newBal > 0){					    	
								...
								$recipient1   = array("phoneNumber" => $phoneNumber,"currencyCode" => "KES", "amount"=> 200,"metadata"=>array("name"=> "Clerk","reason" => "May Salary"));
